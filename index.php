...
var CodeMirror = {};
    ...
    ?>
  <script>
    //block all media download and long click
const allMediaElements = document.querySelectorAll('img, audio, video');

allMediaElements.forEach((mediaElement) => {mediaElement.removeAttribute('download');
